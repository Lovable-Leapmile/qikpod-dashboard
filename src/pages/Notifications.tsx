          ...
          <div className="p-4 border-b border-gray-200 bg-gray-100">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
                {/* Auto Refresh */}
                <div className="flex items-center space-x-2">
                  <Checkbox id="auto-refresh" checked={autoRefresh} onCheckedChange={checked => setAutoRefresh(checked as boolean)} />
                ...
                <div className="relative flex-1 min-w-[200px] sm:min-w-[300px]">
                  ...
                  <Input placeholder="Search notifications..." value={searchText} onChange={onSearchChange} className="pl-10" />
                </div>
            ...
            {loading ? <div className="flex items-center justify-center h-96">
                ...
                <div className="hidden md:block">
                  <div className="ag-theme-alpine h-96 w-full">
                    <AgGridReact rowData={smsData} columnDefs={smsColumnDefs} defaultColDef={defaultColDef} gridOptions={{
                  ...gridOptions,
                  headerHeight: 38,
                  rowHeight: 36,
                  suppressRowClickSelection: true,
                  rowSelection: 'single'
                }} onGridReady={params => setSmsGridApi(params.api)} suppressMenuHide={true} enableRangeSelection={true} />
                  </div>
                </div>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
          ...
          <div className="flex-1 w-full">
            {loading ? <div className="flex items-center justify-center h-96">
                ...
                <div className="hidden md:block">
                  <div className="ag-theme-alpine h-96 w-full">
                    <AgGridReact rowData={emailData} columnDefs={emailColumnDefs} defaultColDef={defaultColDef} gridOptions={{
                  ...gridOptions,
                  headerHeight: 38,
                  rowHeight: 36,
                  suppressRowClickSelection: true,
                  rowSelection: 'single'
                }} onGridReady={params => setEmailGridApi(params.api)} suppressMenuHide={true} enableRangeSelection={true} />
                  </div>
                </div>
