          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Switch
                  // checked when adhoc (since checked = !isStandardMode)
                  checked={!isStandardMode}
                  // onCheckedChange gives the new checked state (true when switched to checked)
                  onCheckedChange={(checked) => setIsStandardMode(!checked)}
                  // apply yellow bg only when switch is checked (i.e., adhoc)
