...
const LocationsTable: React.FC<LocationsTableProps> = ({
  ...
  // Advanced filtering
  const { filters, setFilters, filteredData, resetFilters } = useTableFilters<Location>(
    locations,
    ['primary_name', 'location_name', 'location_address', 'location_pincode', 'id']
  );
          ...
          {loading ? <div className="flex items-center justify-center h-[200px]">
              ...
              <div className="block md:hidden">
                <div className="space-y-4 max-h-[calc(100vh-280px)] overflow-y-auto">
                  {filteredData.map(location => <Card key={location.id} className="bg-white shadow-sm rounded-xl border-gray-200">
