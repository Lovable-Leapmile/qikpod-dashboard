    ...
    <div className="w-full h-full flex flex-col animate-fade-in">
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                <Checkbox
                  id="auto-refresh-pods"
                  checked={autoRefresh}
                  onCheckedChange={checked => setAutoRefresh(checked === true)}
                />
                <label htmlFor="auto-refresh-pods" className="text-sm text-muted-foreground font-medium">
                  Auto Refresh (2m)
                </label>
              </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Select
                ...
                onValueChange={value => setRecordCount(Number(value))}
              >
      ...
      <div className="flex-1 w-full">
        {hasData ? (
            ...
            <div className="block md:hidden">
              <div className="space-y-4 max-h-[calc(100vh-280px)] overflow-y-auto">
                {filteredPods.map(pod => (
                  <PodCard key={pod.id} pod={pod} onPodClick={onPodClick} />
                ))}
              </div>
            </div>
          </>
          ...
          <NoDataIllustration
            title="No pods found"
            description="No pods data available."
            icon="package"
          />
        )}
      </div>
