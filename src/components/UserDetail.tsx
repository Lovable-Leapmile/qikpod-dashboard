                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">Primary</th>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {userLocations.map((location, index) => (
                      <tr key={location.id} className={`${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'} hover:bg-blue-50/50 transition-colors`}>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-700">{location.primary_name}</td>
                        <td className="px-6 py-4 text-sm text-gray-700">{location.primary_contact}</td>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-start">
                          ...
                          <span className={`px-2 py-1 text-xs rounded-full ${
                            reservation.reservation_status === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                          }`}>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {userReservations.map((reservation, index) => (
                      <tr key={reservation.id} className={`${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'} hover:bg-blue-50/50 transition-colors`}>
