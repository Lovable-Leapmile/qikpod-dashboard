    ...
    <div className="p-6 space-y-6">
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-3 md:block md:flex-shrink-0">
              ...
              <h2 className="text-lg font-bold text-gray-900 md:hidden">{userDetail.user_name}</h2>
            </div>
            ...
            <div className="flex-grow min-w-0">
              ...
              <div className="space-y-3 md:space-y-4 mb-4 md:mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                  ...
                  <div className="flex flex-wrap">
                    <span className="text-xs md:text-sm font-medium text-gray-600 uppercase tracking-wider w-20 md:w-24 shrink-0">
                      Phone:
                    </span>
                    <p className="text-gray-900 font-medium text-sm md:text-base break-words min-w-0">
                      {formatValue(userDetail.user_phone)}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                  <div className="flex flex-wrap">
                    ...
                    <p className="text-gray-900 font-medium text-sm md:text-base break-all min-w-0">
                      {formatValue(userDetail.user_email)}
                    </p>
                  </div>
                  <div className="flex flex-wrap">
                    <span className="text-xs md:text-sm font-medium text-gray-600 uppercase tracking-wider w-20 md:w-24 shrink-0">
                    ...
                    <p className="text-gray-900 font-medium text-sm md:text-base break-words min-w-0">
                      {formatValue(userDetail.user_type)}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                  <div className="flex flex-wrap">
                    ...
                    <p className="text-gray-900 font-medium text-sm md:text-base break-words min-w-0">
                      {formatValue(userDetail.user_flatno)}
                    </p>
                  </div>
                  <div className="flex flex-wrap">
                    <span className="text-xs md:text-sm font-medium text-gray-600 uppercase tracking-wider w-20 md:w-24 shrink-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                  <div className="flex flex-wrap">
                    ...
                    <p className="text-gray-900 font-medium text-sm md:text-base break-words min-w-0">
                      {formatValue(userDetail.user_credit_limit)}
                    </p>
                  </div>
                  <div className="flex flex-wrap">
                    <span className="text-xs md:text-sm font-medium text-gray-600 uppercase tracking-wider w-20 md:w-24 shrink-0">
                    ...
                    <p className="text-gray-900 font-medium text-sm md:text-base break-words min-w-0">
                      {formatValue(userDetail.user_credit_used)}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap">
                  ...
                  <p className="text-gray-900 font-medium text-sm md:text-base break-words min-w-0">
                    {formatValue(userDetail.user_address)}
                  </p>
                </div>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full table-fixed">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="w-[10%] px-4 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">
                        ID
                      </th>
                      <th className="w-[20%] px-4 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">
                        Name
                      </th>
                      <th className="w-[30%] px-4 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">
                        Address
                      </th>
                      <th className="w-[10%] px-4 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">
                        Pincode
                      </th>
                      <th className="w-[15%] px-4 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">
                        Primary Name
                      </th>
                      <th className="w-[15%] px-4 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">
                        Primary Contact
                    ...
                    {userLocations.map((location, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 text-sm text-gray-900 font-medium">
                          {formatValue(location.location_name)}
                        </td>
      ...
      <div className="space-y-4">
        ...
        {userReservations.length > 0 ? (
            ...
            {isMobile ? (
              <div className="space-y-3 p-4">
                {userReservations.map((reservation) => (
                  <Card key={reservation.id} className="border border-gray-200 rounded-lg">
                    <CardContent className="p-4">
                      <div className="space-y-2">
                        <div className="flex justify-between items-start">
                          <h4 className="font-semibold text-gray-900">{reservation.drop_by_name}</h4>
                          <span
                            className={`px-2 py-1 text-xs rounded-full ${reservation.reservation_status === "active" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
                          >
          ...
          <NoDataIllustration title="No reservations found" description="This user has no reservations." />
        )}
      </div>
