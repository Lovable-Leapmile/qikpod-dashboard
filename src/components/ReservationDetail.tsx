        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{reservation.status}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">Drop By</label>
              <p className="text-lg font-semibold text-gray-900">{reservation.drop_by_name}</p>
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{reservation.location_name}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">Pickup By</label>
              <p className="text-lg font-semibold text-gray-900">{reservation.pickup_by_name}</p>
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">₹{reservation.payment_amount}</p>
            </div>
          </div>
          ...
          <div className="border-t pt-6">
            ...
            {showMoreDetails && <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{reservation.reservation_type}</p>
                </div>
                <div>
