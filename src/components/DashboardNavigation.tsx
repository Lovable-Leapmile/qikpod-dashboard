                ...
                item.isDropdown ? (
                  <DropdownMenu key={item.name}>
                    <DropdownMenuTrigger asChild>
                      <button
                        className={`h-10 px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center ${
                          item.active
                  ...
                  <button
                    ...
                    className={`h-10 px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                      item.active
                        ? 'bg-yellow-400 text-black'
                        : 'text-black hover:bg-yellow-400 hover:text-black'
                    }`}
