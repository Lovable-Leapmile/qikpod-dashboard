...
const Dashboard = () => {
  ...
  const getPageTitle = () => {
    switch (currentView) {
      ...
      case 'usersNetwork': return 'Users';
      case 'locationDetail': return 'Location Details';
      case 'podDetail': return 'Pod Details';
      case 'reservationDetail': return 'Reservation Details';
      case 'adhocReservationDetail': return 'Adhoc Reservation Details';
  ...
  const getBreadcrumb = () => {
    switch (currentView) {
      case 'dashboard': return 'Dashboard';
      case 'locations': return 'Operations / Locations Management';
      case 'pods': return 'Operations / Pods Management';
      case 'reservations': return 'Operations / Reservations Management';
      case 'usersNetwork': return 'Users & Network / Users Management';
      case 'locationDetail': return 'Operations / Location Details';
      case 'podDetail': return 'Operations / Pod Details';
      case 'reservationDetail': return 'Operations / Reservation Details';
      case 'adhocReservationDetail': return 'Operations / Adhoc Reservation Details';
      default: return 'Dashboard';
    }
  };
